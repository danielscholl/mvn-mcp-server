...
class TestMavenApiService(unittest.TestCase):
    ...
    def test_fetch_artifact_metadata(self, mock_get):
        ...
        # Call the method
        metadata = self.api_service.fetch_artifact_metadata("org.example", "test-artifact")
    ...
    @patch('requests.head')
    @patch('maven_mcp_server.services.maven_api.MavenApiService._check_version_in_metadata')
    ...
    @patch('maven_mcp_server.services.maven_api.MavenApiService.fetch_artifact_metadata')
    ...
    @patch('maven_mcp_server.services.maven_api.MavenApiService.fetch_artifact_metadata')
    @patch('maven_mcp_server.services.maven_api.MavenApiService.check_artifact_exists')
